...
struct nvram_pair router_defaults[] = {
	...
	{ "lan_ipaddr", "192.168.233.1" },		/* LAN IP address */
	{ "lan_netmask", "255.255.255.0" },	/* LAN netmask */
	{ "lan_gateway", "192.168.233.1" },	/* LAN gateway */
	...
	{ "dhcp_start", "192.168.233.2" },	/* First assignable DHCP address */
	{ "dhcp_end", "192.168.233.250" },	/* Last assignable DHCP address */
	{ "dhcp_enable_x", "1" },
	{ "dhcp_lease", "86400" },
	{ "dhcp_gateway_x", "" },
	{ "dhcp_dns1_x", "" },
